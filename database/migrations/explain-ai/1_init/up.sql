...
INSERT INTO public.relationship (from_slug, to_slug, description, audience, priority) VALUES ('javascript', 'html', 'JavaScript is used to add interactivity to HTML pages.', 10, 0);
