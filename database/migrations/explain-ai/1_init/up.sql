...
INSERT INTO public.relationship (from_slug, to_slug, description, priority) VALUES ('javascript', 'css', 'Javascript and CSS work together to make websites look good and function properly.', 0);
INSERT INTO public.relationship (from_slug, to_slug, description, priority) VALUES ('html', 'css', 'JavaScript is used to add interactivity to HTML pages.', 0);
